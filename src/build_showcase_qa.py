...
required_stats = [
    ...
    "retention_m3_ci.csv", "retention_glm.csv", "retention_r0_descriptive.csv", "retention_sensitivity.csv", "retention_cohort_outcome_cells.csv", "retention_model_comparison.csv", "retention_model_diagnostics.csv",
